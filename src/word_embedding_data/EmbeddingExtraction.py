...
if __name__ == "__main__":
    ...
    # # For Job Description Embedding
    # input_folder = "tokenized_data/resume_preprocessed" 
    # output_folder = "word_embeddings/resume_preprocessed_embeddedings"  
    
    # For Resume Embedding
    input_folder = "tokenized_data/resume_preprocessed" 
    output_folder = "word_embeddings/resume_preprocessed_embeddedings"  

    extractor = WordEmbeddingExtractor(input_folder, output_folder)

    # Extract word embeddings and store them in subfolders by category
